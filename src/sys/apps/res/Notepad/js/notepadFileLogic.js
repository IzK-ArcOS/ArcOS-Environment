...
function loadNotepad() {
    setTimeout(() => {
        let path = "../apps/res/notepad/save/" + document.getElementById("notepadLoadFileInput").value;
        ...
        fs.readFile(path, 'utf8', function (err, data) {
            if (err) {
                ...
                ConsoleNotifier.notifyStartService("ArcOS.System.res.notepad.notepadFileLogic.loadNotepad: " + document.getElementById("notepadLoadFileInput").value)
                for (let i = 0; i < 200; i++) {
...
function saveNotepad() {
    let path = "/system/applications/res/notepad/save/" + document.getElementById("notepadSaveFileInput").value;
    notepadLoadedFile = path;
...
function deleteNotepad() {
    let path = "src/sys/applications/res/notepad/save/" + document.getElementById("notepadDeleteFileInput").value;
    let fs = require("fs");
