function fileExplorerOpenDir(dirName) {
    ...
    fs.readdir(dirName, { encoding: "ascii" }, function (err, files) {
        ...
        for (let i = 0; i < files.length; i++) {
            ...
            if (isDir(dirName + "/" + files[i])) {
                ...
                switch (extension) {
                    ...
                    case "webp":
                    case "bmp":
                        image.src = "./../img/image viewer.svg";
                        break;
                    case "ecs":
                        image.src = "./../img/execute command.svg";
                        break;
                    case "mp3":
                    case "wav":
                    case "flac":
                        image.src = "./../img/music player.svg";
                        break;
                    default:
                        image.src = "./../img/file.svg";
                }
        ...
        fileExplorerCurrentDir = dirName.replace("//", "/");
