<div class="window" id="Clock" onclick="windowLogic.bringToFront(this);">
    ...
    <div class="body">
        <div class="clockSidebar">
            ...
            <hr>
            <button onclick="clockSwitchPage('timer',1)"><span
                    class="material-icons">hourglass_bottom</span>Timer</button><br>
            <button onclick="clockSwitchPage('stopwatch',2)"><span
                    class="material-icons">timer</span>Stopwatch</button><br>
...
<link rel="stylesheet" href="./../apps/clock.css">