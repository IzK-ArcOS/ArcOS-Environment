...
async function openSettingsPane(name, buttonNode) {
    ...
    switch (name) {
        case `home`:
            switchControlPanelPage(path.join(__dirname, `../apps/newSettings/inline/home.inline`));
            break;
        case `user`:
            switchControlPanelPage(path.join(__dirname, `../apps/newSettings/inline/user.inline`));
            break;
        case `personalize`:
            ...
            switchControlPanelPage(path.join(__dirname, `../apps/newSettings/inline/personalize.inline`));
            break;
        case `addapp`:
            switchControlPanelPage(path.join(__dirname, `../apps/newSettings/inline/addapp.inline`));
            break;
        case `profpicsel`:
            if (localStorage.getItem("safeMode") == "1") {
            ...
            switchControlPanelPage(path.join(__dirname, `../apps/newSettings/inline/profilePictureSelector.inline`));
            break;
        case `manusers`:
            if (localStorage.getItem("safeMode") == "1") {
            ...
            switchControlPanelPage(path.join(__dirname, `../apps/newSettings/inline/manageOtherUsers.inline`));
            break;
        case `manacc`:
            if (localStorage.getItem("safeMode") == "1") {
            ...
            switchControlPanelPage(path.join(__dirname, `../apps/newSettings/inline/manageProfile.inline`));
            break;
        case `about`:
            switchControlPanelPage(path.join(__dirname, `../apps/newSettings/inline/about.inline`));
            break;
        case 'updates':
            if (process.platform == "win32") {
                await switchControlPanelPage(path.join(__dirname, '../res/settings/inline/noupdates.inline'));
            } else {
                await switchControlPanelPage(path.join(__dirname, '../res/settings/inline/updates.inline'));
            }
            break;
    }
