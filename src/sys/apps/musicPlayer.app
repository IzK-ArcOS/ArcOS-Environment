<div class="window" id="Music Player" onclick="windowLogic.bringToFront(this);">
    <div class="windowTitle" onclick="windowLogic.bringToFront(parentNode);">
        ...
        <button onclick="windowLogic.closewindow(this.parentNode.parentNode);mediaPlayerStop();"
            class="title close"><span class="material-icons">close</span></button>
...
<link rel="stylesheet" href="./../apps/musicPlayer.css">