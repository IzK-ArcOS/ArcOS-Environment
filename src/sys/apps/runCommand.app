<div class="window" id="Execute Command" onclick="windowLogic.bringToFront(this);">
    ...
    <div class="body" onclick="windowLogic.bringToFront(parentNode);">
        ...
        <center>
            ...
            <button class="runDialogExecute"
                onclick="ArcTermUI.executeProgram([document.getElementById('runDialogInput').value])">Execute</button>
        </center>
    </div>
</div>

<link rel="stylesheet" href="./../apps/runCommand.css">