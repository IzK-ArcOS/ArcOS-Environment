<div class="window" id="File Manager" onclick="windowLogic.bringToFront(this);">
    <div class="windowTitle" onclick="windowLogic.bringToFront(parentNode);" ondblclick="windowLogic.toggleMaximizedState(this.parentNode);">
        <button class="titleAction" onclick="getDriveLetters();"><img src="./system/images/hdd.svg"></button>
        ...
        <button class="titleAction" onclick="windowLogic.openWindow('File Manager - Delete Folder');"><img src="./system/images/File Manager - Delete Folder.svg"></button>
        <button class="titleAction" onclick="windowLogic.openWindow('File Manager - Rename Folder');"><img src="./system/images/File Manager - Rename Folder.svg"></button>
    ...
    <div class="body" onclick="windowLogic.bringToFront(parentNode);">
        <div class="fileExplorerTopPane">
            <button onclick="fileExplorerParentDir()"><span class="material-icons">expand_less</span></button>
            <input class="fullwidth" id="fileExplorerAddressBar">
            <button onclick="fileExplorerOpenDir(document.getElementById('fileExplorerAddressBar').value);"><span class="material-icons">chevron_right</span></button>
        </div>
