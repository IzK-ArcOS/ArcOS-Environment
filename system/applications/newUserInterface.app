<div class="newStartMenu" id="startMenu">
    ...
    <div class="rightPane">
        ...
        <button class="transparent fullWidth textAlignLeft" onclick="openSettingsPane('personalize',document.getElementsByClassName('controlPanelSidebar')[1]);openWindow('Settings');"><span
                class="material-icons"
                style="font-size:20px;vertical-align: bottom;">palette</span>&nbsp;&nbsp;Personalization</button><br>
        <button class="transparent fullWidth textAlignLeft" onclick="openSettingsPane('addapp',document.getElementsByClassName('controlPanelSidebar')[2]);openWindow('Settings');"><span
                class="material-icons" style="font-size:20px;vertical-align: bottom;">extension</span>&nbsp;&nbsp;Import
            App</button><br>
        <button class="transparent fullWidth textAlignLeft" onclick="openSettingsPane('user',document.getElementsByClassName('controlPanelSidebar')[3]);openWindow('Settings');"><span
                class="material-icons"
...
<div class="notificationCenter retracted" id="notificationCenter">
    ...
    <span style="display:flex">
            <div class="notificationCenterAction">
                ...
                <input type="range" min="1" max="10" id="systemVolumeSlider" style="width:50%;padding:0px;" class="slider">
            </div>
            <div class="notificationCenterAction">
            </div>
        </span>
