<div class="newStartMenu small" id="startMenu">
    <div class="bottomPane">
        ...
        <button class="transparent newStartMenuShutDownButton" onclick="windowLogic.openWindow('Shut Down ArcOS');"><span class="material-icons"
...
<div class="taskbar" id="taskbar">
    ...
    <span style="float:right;height:43px;">
        <button class="startButton" style="height:100%;margin-right:10px;padding-top:12px;"id="notificationCenterButton" onclick="notificationLogic.toggleNotificationCenter();">
